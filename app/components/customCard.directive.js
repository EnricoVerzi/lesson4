(function() {
    ...
    angular
        .module('todoApp')
        .directive('customCard', directive);
    ...
    function directive() {
        return {
            ...
            transclude: true,
            restrict: 'E',
            templateUrl: 'app/components/customCard.template.html' 
        };
    }


    customCardController.$inject = ['storageService', '$mdDialog'];

    //Directive controller
    function customCardController(storageService, $mdDialog) {
        var vm = this;
